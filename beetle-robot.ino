...
void loop() {
  ...
  if (irrecv.decode(&results)) {
    ...
    if (hasCode(IR_COMMAND_FORWARD_CODES, results.value) ||
      ...
      Serial.println("IR_COMMAND_FORWARD_CODES || IR_COMMAND_FORWARD_LEFT_CODES || IR_COMMAND_FORWARD_RIGHT_CODES");
      attachServos();
      isStopped = false;
      angleShiftLeftServo = 0;
      angleShiftRightServo = 0;
      ...
      Serial.println("IR_COMMAND_BACKWARD_CODES || IR_COMMAND_BACKWARD_LEFT_CODES || IR_COMMAND_BACKWARD_RIGHT_CODES");
      attachServos();
      isStopped = false;
      angleShiftLeftServo = 0;
      angleShiftRightServo = 0;
      ...
      if (hasCode(IR_COMMAND_BACKWARD_LEFT_CODES, results.value)) {
        Serial.println("IR_COMMAND_BACKWARD_LEFT_CODES");
        amplitudeRightServo = SIDE_SERVOS_HALF_AMPLITUDE;
      } else if (hasCode(IR_COMMAND_BACKWARD_RIGHT_CODES, results.value)) {
        Serial.println("IR_COMMAND_BACKWARD_RIGHT_CODES");
        amplitudeLeftServo = SIDE_SERVOS_HALF_AMPLITUDE;
      }
    } else if (hasCode(IR_COMMAND_TURN_LEFT_CODES, results.value)) {
      Serial.println("IR_COMMAND_TURN_LEFT_CODES");
      attachServos();
      isStopped = false;
      angleShiftLeftServo = 0;
      ...
      Serial.println("IR_COMMAND_TURN_RIGHT_CODES");
      attachServos();
      isStopped = false;
      angleShiftLeftServo = 0;
      angleShiftRightServo = PI;
      ...
      Serial.println("IR_COMMAND_STOP_CODES");
      attachServos();
      isStopped = true;
      angleShiftLeftServo = 0;
      angleShiftRightServo = 0;
      ...
      Serial.println("IR_COMMAND_VERY_SLOW_CODES");
      ...
      Serial.println("IR_COMMAND_SLOW_CODES");
